...
getData.addEventListener("click",() => {
    ...
    let arrayHtml = `<table><thead><tr> <th>નિદર્શ ક્રમ</th><th>X̅</th><th>R</th> </tr></thead> <tbody>`;
    ...
    let methData = `<table><tr><td><math xmlns='http://www.w3.org/1998/Math/MathML'><mi> &#x00B5;</mi> <mo> = </mo> <mfrac> <mrow> <mo> &#x2211;</mo> <mover> <mrow> <mi> X </mi> </mrow> <mrow> <mo> __ </mo> </mrow> </mover> </mrow> <mrow> <mi> m </mi> </mrow> </mfrac> <mo> = </mo> <mfrac> <mrow> <mn> ${xArraySum} </mn> </mrow> <mrow> <mn> ${no.length} </mn> </mrow> </mfrac> <mo> = </mo> <mn><b> ${_X_} </b></mn> </math> </td></tr>`
    ...
    let xclData = `<p id="chName">X̅ આલેખ નિયંત્રણ સીમાઓ</P> <table ><tr><td><b>C.L. = X̅ = ${xArraySum / no.length}</b></td></tr></table>`
    xclData += `<table >
    ...
    let rclData = `<p id="chName">R આલેખ નિયંત્રણ સીમાઓ</P> <table ><tr><td><b>C.L. = R = ${_R_}</b></td></tr></table>`
    rclData += `<table >
